 ...
 */
package br.com.brolam.cloudvision.ui.camera;
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public List<T> getOrcGraphics() {
        Object[] orcGraphics = new Object[mGraphics.size()];
        mGraphics.toArray(orcGraphics);
        Arrays.sort(orcGraphics);
        ArrayList<T> arrayList = new ArrayList<>();
        for(Object t : orcGraphics ){
            arrayList.add((T)t);
        }
        return arrayList;
    }
