 ...
 * @since Release 01
 */
public class CoordinatorLayoutHelper extends CoordinatorLayout {


    public CoordinatorLayoutHelper(Context context) {
        super(context);
    }

    public CoordinatorLayoutHelper(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CoordinatorLayoutHelper(Context context, AttributeSet attrs, int defStyleAttr) {
